...
%         load('stack_i.mat');
%         load('W_t_i.mat');
%         test_data_cell = dataforrbm_test(test_data_cell,stack_i,W_t_i,eI);
%         test_data_cell{1,1} = test_data_cell{1,1}';
        %%
%         eI.inputDim = 1000;
%         eI.layerSizes = [1000,1026];
...
%     end
if ieval == 2
        save sdr[clapia]rtrbm rSDR;
        save sir[clapia]rtrbm rSIR;
      
        save nsdr[clapia]rtrbm rNSDR;
end
