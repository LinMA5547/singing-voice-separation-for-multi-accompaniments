...
% fprintf(1,'@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@22');
% %BSS EVAL setting
% theta.a = zeros(1539,1);theta.b = stack_i{1}.b;theta.w_vh = stack_i{1}.W;theta.w_hh=W_t_i;
% 
% eI.actfun_vis='logistic';eI.actfun ='logistic'; eI.cdn =1;
%  theta = rtrbm( data_cell,theta,1539,1000,400,'logistic','logistic',1,1);
%  theta1 = rtrbm_stack2params(theta);
% %  grad1 = zeros(size(theta1));
% %  for i = 1:400
% [theta,grad]=minFunc(@drdae_discrim_rtrbm, theta1,options, eI, ...
%     data_cell, 1539,1000);
%  end
% theta = rtrbm( data_cell,theta,1539,1000,maxepoch,actfun,actfun,rnn,cdn )
global SDR;
